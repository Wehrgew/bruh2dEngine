/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.36 on Wed Apr 15 11:01:25 2026.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.6,gles1=1.0,gles2=3.2,glsc2=2.0" --generator="c" --spec="gl" --extensions="GL_ARB_debug_output,GL_ARB_instanced_arrays,GL_ARB_texture_non_power_of_two"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.6&api=gles1%3D1.0&api=gles2%3D3.2&api=glsc2%3D2.0&extensions=GL_ARB_debug_output&extensions=GL_ARB_instanced_arrays&extensions=GL_ARB_texture_non_power_of_two
*/
